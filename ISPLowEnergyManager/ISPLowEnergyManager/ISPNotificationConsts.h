...
#pragma mark ISPLowEnergyManager Internal/External Notfication Strings
...
#pragma mark --> ISPLowEnergyManager Callbacks
...
#pragma mark --> CBPeripheralDelegate (via ISPLowEnergyManager) Callbacks
